<?php @require ("../../configuracion.lagc.php");
$rptlugar = mysql_query("select * from cp_locales where cp_lid=".$_GET['lugar']." and cp_lactivado='1'");
...
<title>Local: <?php echo $lugar['cp_lnombre']; ?></title>
</head>
<body>
<!--
