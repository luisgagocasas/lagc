<div class="botonesdemando"><h3><a href="?lagc=com_musica&musica=<?=time(); ?>&cantante_musica=<?=time(); ?>">&laquo; Atras</a> | Creando Nuevo Cantante o Agrupacion</h3></div>
    ...
    <tr>
      <td valign="top"><table border="0" cellpadding="5">
          ...
          <tr>
            ...
            <td><input name="anioinic" type="text" value="" class="inp-form" size="36"><br /><br /></td>
          </tr>
          <tr>
            <th align="right">Pais de Origen: </th>
            <td><input name="paisori" type="text" value="" class="inp-form" size="36"><br /><br /></td>
          </tr>
          <tr>
            <th align="right">Ultimos Premios: </th>
            <td><textarea name="premios" class="form-textarea" cols="40" rows="5"></textarea><br /><br /></td>
          </tr>
          <tr>
