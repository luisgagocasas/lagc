<div class="botonesdemando"><h3><a href="?lagc=com_musica&musica=<?=time(); ?>&genero_musica=<?=time(); ?>">&laquo; Atras</a> | Editando: <em><?=$cont['genero_nombre']; ?></em></h3></div>
    ...
    <tr>
      <td valign="top"><table border="0" cellpadding="5">
          <tr>
            ...
            <td><input name="titulo" type="text" value="<?=$cont['genero_nombre']; ?>" class="inp-form" size="36"><br /><br /></td>
          </tr>
          <tr>
            <th align="right">Descripcion: </th>
            <td><textarea name="resumen" class="form-textarea" cols="40" rows="5"><?=$cont['genero_descripcion']; ?></textarea><br /><br /></td>
          </tr>
          <tr>
            <th align="right">Css: </th>
            <td><textarea name="css" class="form-textarea" cols="40" rows="5"><?=$cont['genero_css']; ?></textarea><br /><br /></td>
          </tr>
          <tr>
            <th align="right"></th>
            <td>
