...
<div class="botonesdemando"><h3><a href="?lagc=com_videos&videos=<?=time(); ?>&categorias=<?=time(); ?>">&laquo; Atras</a> | Editando Categoria: <em><?=$cont['vi_ca_titulo']; ?></em></h3></div>
    ...
    <tr>
      <td valign="top"><table border="0" cellpadding="5">
          <tr>
            ...
            <td><input name="titulo" type="text" value="<?=$cont['vi_ca_titulo']; ?>" class="inp-form" size="36"><br /><br /></td>
          </tr>
          <tr>
            <th align="right" valign="top">Resumen: </th>
            <td><textarea id="form-textarea" name="resumen" onkeypress="return limita(event, 255, 'form-textarea');" onkeyup="actualizaInfo(255, 'form-textarea', 'info')" class="mceNoEditor" cols="40" rows="5"><?=$cont['vi_ca_descripcion']; ?></textarea><br />
      ...
      <td valign="top">
        <div id="related-activities">
          ...
          <div id="related-act-bottom">
            ...
            <img src="../../../componentes/com_imagenes/thumbnails/<?=$cont['vi_ca_imagen']; ?>" name="img1" border="0" />
            </div>
            <input type="text" name="img1" value="<?=$cont['vi_ca_imagen']; ?>" onfocus="document.images.img1.src='../../../componentes/com_imagenes/thumbnails/'+this.value" class="borderinputimg">
              </div>
              <div class="clear"></div>
              <div class="lines-dotted-short"></div>
              <div class="left"><a><img src="plantillas/lagc-peru/imagenes/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
