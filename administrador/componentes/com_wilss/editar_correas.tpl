...
<div class="botonesdemando"><h3><a href="?lagc=com_wilss&wilss=<?=time(); ?>&correas=<?=time(); ?>">&laquo; Atras</a> | Editar Correas</h3></div>
...
<img src="../../../componentes/com_imagenes/imagenes/<?=$cont['co_img1']; ?>" name="img1" border="0" />
</div>
<input type="text" name="img1" value="<?=$cont['co_img1']; ?>" onfocus="document.images.img1.src='../../../componentes/com_imagenes/imagenes/'+this.value" class="borderinputimg">
</td>
</tr>
<tr>
<td height="300" align="center" valign="middle">
<div class="fondoimg" style="width:680px; height:260px; cursor:pointer;" onclick="abrirventana('2');">
<img src="../../../componentes/com_imagenes/imagenes/<?=$cont['co_img2']; ?>" name="img2" border="0" />
</div>
<input type="text" name="img2" value="<?=$cont['co_img2']; ?>" onfocus="document.images.img2.src='../../../componentes/com_imagenes/imagenes/'+this.value" class="borderinputimg">
</td>
</tr>
<tr>
<td height="300" align="center" valign="middle">
<div class="fondoimg" style="width:680px; height:260px; cursor:pointer;" onclick="abrirventana('3');">
<img src="../../../componentes/com_imagenes/imagenes/<?=$cont['co_img3']; ?>" name="img3" border="0" />
</div>
<input type="text" name="img3" value="<?=$cont['co_img3']; ?>" onfocus="document.images.img3.src='../../../componentes/com_imagenes/imagenes/'+this.value" class="borderinputimg">
</td>
</tr>
<tr>
<td height="300" align="center" valign="middle">
<div class="fondoimg" style="width:680px; height:260px; cursor:pointer;" onclick="abrirventana('4');">
<img src="../../../componentes/com_imagenes/imagenes/<?=$cont['co_img4']; ?>" name="img4" border="0" />
</div>
<input type="text" name="img4" value="<?=$cont['co_img4']; ?>" onfocus="document.images.img4.src='../../../componentes/com_imagenes/imagenes/'+this.value" class="borderinputimg">
</td>
</tr>
</table>
      </td>
      <td valign="top">
        <div id="related-activities">
          ...
          <div id="related-act-bottom">
            <div id="related-act-inner">
              ...
              <div class="right">
              <h5>Titulo</h5><br />
              <input name="titulo" type="text" class="inp-form" size="36" value="<?=$cont['co_nombre']; ?>">
              </div>
              <div class="clear"></div>
              ...
              <div class="right">
                <h5>Fechas</h5><br />
                <ul class="greyarrow">
                  <li>Creado el <a><?=date("Y/m/d", $cont['co_creado']); ?></a></li>
                  <?php if (!empty($cont['co_modificado'])) { ?><li>Modificado el: <a><?=date("Y/m/d", $cont['co_modificado']); ?></a></li><?php } ?>
                </ul>
              </div>
              <div class="clear"></div>
              <div class="lines-dotted-short"></div>
        ...
        <input type="button" value="Aplicar" class="form-aplicar" onClick="enviar('<?="?lagc=com_wilss&wilss=".$_GET['wilss']."&editar_correas=".LGlobal::Url_Amigable($_GET['editar_correas']); ?>&aplicar=continuar')">
        </center>
	</td>
    </tr>
  </table>
