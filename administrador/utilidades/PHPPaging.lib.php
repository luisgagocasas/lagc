...
*
*	Permite personalizar el número elementos mostrados en cada pagina, así como el
...
class PHPPaging {
	...
	*	Valor por default: 5
	*
	*	Número de elementos que será mostrado por pagina. Puede ser definido en el script
	...
	*/
	...
	/**
	*	Número de paginas anteriores a la actual a las que se mostrará un link directo
	*
	*	Valor por default: 3
	*
	*	En barra de links, número de paginas anteriores a la actual a mostrar. Puede ser 
	...
	*/
	...
	/**
	*	Número de paginas posteriores a la actual a las que se mostrará un link directo
	*
	*	Valor por default: 3
	*
	*	En barra de links, número de paginas posteriores a la actual a mostrar. Puede ser
	...
	*	Valor por default: "&nbsp;"
	*
	*	Separador que se usara en la barra de links, entre pagina y pagina. 
	...
	*   según el número por:
	*		- %1$s = Número de pagina
	*		- %2$s = Primer resultado mostrado
	*		- %3$s = Último Resultado mostrado
	*		- %4$s = Total de resultados de la BD
	*
	*	<code>
	*	var $linkTitulo = "Resultados del %2\$s al %3\$s de %4\$s encontrados (pagina %1\$s)";
	*	</code>
	*	Podria ser reemplazado por:
	*	"Resultados del 13 al 18 de 127 encontrados (pagina 3)"
	*	@var string
	**/
	var $linkTitulo = true;
	
	/**
	*	Cadena que se mostrará en el link hacia la PRIMERA pagina
	*
	*	Valor por default: "&laquo; Primera"
	*
	*	Cadena de texto que se mostrará en el enlace hacia la primera pagina.
	*
	*	<code>
	*	var $mostrarPrimera = "- Ir a la primera pagina";
	*	</code>
	*	@var string
	**/
	...
	/**
	*	Cadena que se mostrará en el link hacia la ÚLTIMA pagina
	*
	*	Valor por default: "Última &raquo;"
	*
	*	Cadena de texto que se mostrará en el enlace hacia la última pagina.
	*
	*	<code>
	*	var $mostrarPrimera = "Ir a la última pagina -";
	*	</code>
	*	@var string
	**/
	...
	/**
	*	Cadena que se mostrará en el link hacia la pagina ANTERIOR
	*
	*	Valor por default: "&lt; Anterior"
	*
	*	Cadena de texto que se mostrará en el enlace hacia la pagina anterior
	*
	*	<code>
	...
	**/
	...
	/**
	*	Cadena que se mostrará en el link hacia la pagina SIGUIENTE
	*
	*	Valor por default: "Siguiente &gt;"
	*
	*	Cadena de texto que se mostrará en el enlace hacia la pagina siguiente
	*
	*	<code>
	...
	**/
	...
	/**
	*	Cadena que se mostrará en el link hacia las paginas accesibles en barra de links
	*
	*	Valor por default: "{n}"
	*
	*	Cadena de texto que se mostrará para indicar las paginas a las que se puede
	*	acceder desde la barra de links, y que SÍ SERÁN LINKS. El lugar donde se desea 
	*	que vaya el número de pagina se debe indicar por medio del caracter {n}.
	*
	*	<code>
	...
	**/
	...
	/**
	*	Cadena que se mostrará en vez del link hacia la pagina ACTUAL
	*
	*	Valor por default: "{n}"
	*
	*	Cadena de texto que se mostrará para indicar la pagina actual, que estará en 
	*	la barra de links, pero NO SERÁ UN LINK. El lugar donde se desea que vaya el
	*	número de pagina se debe indicar por medio del caracter {n}.
	*
	*	<code>
	*	var $mostrarActual = "pagina <b>{n}</b>";
	*	</code>
	*	@var string
	**/
	var $mostrarActual = "{n}";
	...
	* 	amigables". Si no se define, el número de pagina se propaga por la URL
	* 	de esta forma: pagina.php?page=4. En la estructura que usted coloque
	* 	el lugar donde debe ponerse el número de pagina debe ir indicado como
	* 	%1$s
	*
	*	<code>
	...
	* 	propaga el número de pagina es incluída siempre automáticamente. Esta 
	...
	* 	propaga el número de pagina siempre se incluye en la URL
	...
	*	Número de elementos por pagina
	*
	*	Define el número de registros que serán mostrados en cada pagina
	*	@param number $num Número de registros por pagina que se usará
	*	@returns bool
	**/
	function porPagina ($num) {
		if (is_numeric($num) and $num >= 1 and $num !== true) $this->porPagina = intval($num);
		else return $this->error(true, "El número de elementos por pagina indicado es inválido. Sólo puede poner números enteros mayores o iguales a 1.");
		return true;
	}
	...
	*	Nombre de variable en la URL
	*
	*	Define el nombre de la variable de url que indicará el número de pagina
	...
	*	Número de paginas anteriores a la actual a las que se mostrará un link directo
	*
	*	Define el número de links a paginas anteriores a la actual que serán mostrados en
	*	la barra de links
	*	@param number $num Número de paginas anteriores a la actual
	*	@returns bool
	**/
	...
	*	Número de paginas posteriores a la actual a las que se mostrará un link directo
	*
	*	Define el número de links a paginas posteriores a la actual que serán mostrados en
	*	la barra de links
	*	@param number $num Número de paginas posteriores a la actual
	*	@returns bool
	**/
	...
	*	Cadena que se mostrará en el link hacia la PRIMERA pagina
	*
	*	Define la cadena que será mostrada en el enlace hacia la primera pagina
	...
	*	Cadena que se mostrará en el link hacia la ÚLTIMA pagina
	*
	*	Define la cadena que será mostrada en el enlace hacia la última pagina
	*	@param string $str Cadena a mostrar
	*	@returns void
	**/
	...
	*	Cadena que se mostrará en el link hacia la pagina ANTERIOR
	*
	*	Define la cadena que será mostrada en el enlace hacia la pagina anterior
	*	@param string $str Cadena a mostrar
	*	@returns void
	**/
	...
	*	Cadena que se mostrará en el link hacia la pagina SIGUIENTE
	*
	*	Define la cadena que será mostrada en el enlace hacia la pagina siguiente
	*	@param string $str Cadena a mostrar
	*	@returns void
	**/
	...
	*	Cadena que se mostrará en el link hacia las paginas accesibles en barra de links
	*
	*	Define la cadena que será mostrada en el enlace hacia las paginas accesibles 
	*	desde la barra de links. El número de pagina deberá ser indicado como {n}
	*	@param string $str Cadena a mostrar
	*	@returns void
	* 	@version 2.0
	**/
	...
	*	Cadena que se mostrará en vez del link hacia la pagina ACTUAL
	*
	*	Define la cadena que será mostrada como pagina actual en la barra de links. El 
	*	número de pagina (pagina actual) deberá ser indicado como {n}
	*	@param string $str Cadena a mostrar
	*	@returns void
	**/
	...
	*		- %3$s = Último Resultado mostrado
	*		- %4$s = Total de resultados de la BD
	*		- %5$s = Número total de paginas // version 2.0
	...
	* 	las URLs en una forma "amigable". El lugar donde debe ir el número de pagina debe ser
	...
	* 	la barra de navegación. La variable que propaga el número de pagina es incluida siempre y 
	...
	* 	la barra de navegación. La variable que propaga el número de pagina no puede ser quitada,
	...
	*
	*	Devuelve el número total de paginas
	*	@returns int
	**/
	function numTotalPaginas () {
		if($this->done != true) return $this->error(true, "No se puede mostrar el número total de paginas pues no se ha realizado ninguna paginación");
	...
	**/
	function numEstaPagina () {
		if($this->done != true) return $this->error(true, "No se puede mostrar el número de pagina actual pues no se ha realizado ninguna paginación");
	...
	**/
	...
	/**
	*	Número de registros mostrados en esta pagina
	*
	*	Devuelve el número de registros mostrados en la pagina actual
	*	@returns int
	**/
	function numRegistrosMostrados () {
		if($this->done != true) return $this->error(true, "No se puede obtener el número de registros mostrados en la pagina actual pues no se ha realizado ninguna paginación");
	...
	function error($desarrollo = true, $msg, $query = false, $limit_error = null) {
		if($this->modo != 'publicacion' and $this->mostre_error == false) {
			if($this->modo == 'reporte') {
				...
				if($limit_error == true) $error.= "El error probablemente se deba a que en la consulta MySQL que usted indicó aparentemente ya existía una cláusula LIMIT, la cuál es añadida automáticamente por el paginador. Más información en la pagina web del script.<br /><br />";
				$error.= "Si no logra solucionar el problema, envíe un mensaje a <code>webmaster@portuhermana.com</code> indicando el error mostrado y la consulta que generó el error";
			} else {
				$error = "Hubo un error ejecutando la paginación. El mensaje devuelto es: <blockquote><code style='color: #080; font-size: 13px;'><strong>$msg</strong></code></blockquote>Si no logra solucionar el problema, envíe un mensaje a <code>webmaster@portuhermana.com</code> indicando el error mostrado y la consulta que generó el error";
			}
