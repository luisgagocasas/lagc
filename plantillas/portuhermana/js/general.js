...
$.include('plantillas/portuhermana/js/jquery.smoothmenu.js')
$.include('plantillas/portuhermana/js/jflickrfeed.min.js');

if($('#showcase').length) {
	$.include('plantillas/portuhermana/js/jquery.aw-showcase.js');
}

if($('#mycarousel').length) {
	$.include('plantillas/portuhermana/js/jquery.jcarousel.min.js');
}

if($('#jplayer').length) {
	$.include('plantillas/portuhermana/js/jquery.jplayer.min.js');
}

if($('#gallery').length) {
	$.include('plantillas/portuhermana/js/jquery.easing.1.3.js');
	$.include('plantillas/portuhermana/js/jquery.quicksand.js');
}

if($('.zoomer').length) {$.include('plantillas/portuhermana/fancybox/jquery.fancybox.pack.js');}
if($('#jstwitter').length) {$.include('plantillas/portuhermana/js/twitter.js');}
if($('.star').length) {$.include('plantillas/portuhermana/js/jquery.raty.min.js');}
if($('#scroll-pane').length) {$.include('plantillas/portuhermana/js/jquery.mousewheel.js');}
if($('#scroll-pane').length) {$.include('plantillas/portuhermana/js/jquery.jscrollpane.min.js');}
...
/* Nivo Slider --> Begin */
	if ($('#imageSlider').length) {
		$.include('plantillas/portuhermana/sliders/nivo-slider/jquery.nivo.slider.js');
...
/* Panel --> Begin */
$.include('plantillas/portuhermana/themeChanger/js/colorpicker.js')
$.include('plantillas/portuhermana/themeChanger/js/themeChanger.js')
/* Panel --> End */
...
/* Flickr Photos --> Begin */	
	...
	itemTemplate: '<li><a href="http://www.flickr.com/photos/82237574@N05"><img src="{{image_s}}" alt="{{title}}" /></a></li>'
