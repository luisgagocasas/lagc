...
$(function() {
    ...
    if (typeof page_config != 'undefined' && $theme_control_panel) {
        ...
        if (page_config.nav) {
			...
			var $header = $('#header');
            var bg_change_html = '<span>Diseño del Menu:</span>';
            bg_change_html += '<ul>';
        ...
        if (page_config.backgrounds) {
            ...
            var bg_change_html = '<span>Fondos:</span>';
            bg_change_html += '<ul>';
        ...
        if (page_config.styles) {
			...
			$links_color = $('<div/>').attr({
                    ...
                    $links_color_wrapper.append('<span>Color de Enlaces :</span>', $links_color);
